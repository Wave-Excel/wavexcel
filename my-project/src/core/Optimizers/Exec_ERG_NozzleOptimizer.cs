...
// using Models.PreFeasibility;
namespace Optimizers.Exec_ERG_NozzleOptimizer;
public class ExecutedNozzleOptimizer
{
    ...
    protected NozzleCalculationsData nozzleData;
    protected TurbaOutputModel turbaOutputModel;
    protected NozzleTurbaDataModel nozzleTurbaDataModel;
    protected ILogger logger;
    private PreFeasibilityDataModel preFeasibilityDataModel;
    public static double A1 = 0;
    public static double A2 = 0;

    public ExecutedNozzleOptimizer(){
        ...
        this.logger = MainExecutedClass.GlobalHost.Services.GetRequiredService<ILogger>();
    }
    public virtual bool RuleEngineAlgorithmForNozzles()
    {   
        nozzleOptimizeCount++;
        GNozzleCount++;
        ...
        else
        {
            ...
            {
                return this.RuleEngineAlgorithmForNozzles();
                //return false;
            }
    ...
    public virtual void Logger(string message)
    {
        logger.LogInformation(message);
        // Console.WriteLine(message);
    }
    public virtual void TerminateIgniteX(string message)
    {
    ...
    // }
    public virtual double[] BlackBoxFunction(double NA, double NB)
    {   
    ...
    public virtual void UpdateNozzleSpecs(double NozzleCount, double NozzleFront){
    ...
    public virtual double EvaluateFitness(double NA, double NB)
    {
        //Logger("fmIN1 UPPER limit " + turbaOutputModel.Fmin1_UpperLimit);
        ...
        Na = outputs[1];
        Nb = outputs[2];
        //double[] outputs = BlackBoxFunction(NA, NB);
