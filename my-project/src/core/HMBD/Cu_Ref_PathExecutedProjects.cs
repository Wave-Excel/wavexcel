namespace HMBD.Cu_Ref_PathExecutedProjects;
using System;
using System.IO;
// using Microsoft.Office.Interop.Excel;
using Models.ExecutedProjectDB;
public class CuFilePathUpdater
{
    // ExecutedProjectDB executedProjectDB;
    ExecutedDB executedDB;
    public CuFilePathUpdater(){
    ...
    public void ExecutedUpdateFilePaths()
    {
        ...
        try
        {
            ...
            string folderPath1 = @"\\invadi7fla.ad101.siemens-energy.net\ai@stg\Database for cu_SwitchingIteratingExecuted.Executed Turbine\prodis\";
